...
## Compilación
Para compilar `analisis_escalas.tex` es necesario tener instalado `lilypond` en su versión 2.22 y `texlive` en su versión 2021. El comando para compilar es `lualatex --shell-escape analisis_escalas.tex`.
