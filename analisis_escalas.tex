...
\noindent Si consideramos sólo la capa 3 ---la más profunda--- estamos ante una escala tritónica; con dos capas --- capas 3 y 2---, se presenta ante nosotros la escala pentatónica vista en el apartado~\ref{subsec:escala-sin-tensiones} de la página~\pageref{subsec:escala-sin-tensiones}; y lo obvio: las tres capas actuando en conjunto revelan la escala heptatónica de la Figura. Al igual que en una carta del \emph{Tarot}, en \musncp{\relative{c' d e f g a b c}} hay mucho más que lo que a simple vista se ve. Decodificar es necesario, y para ello ---también es obvio--- hay que conocer el código.
