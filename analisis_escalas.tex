...
\addlyrics {
  ...
  \markup \setHas "D" #'(("a"."5♯"))
  \markup \setHas "D" #'(("a"."7")("b"."9"))
  \markup \setHas "D" #'(("a"."5♭")("b"."5♯")("c"."7")("d"."9"))
}
\end{lilypond}
